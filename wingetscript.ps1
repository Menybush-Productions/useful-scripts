...
do {
	...
	Where-Object {
		...
		$line -ne $header1 -and
		$line -ne $footer -and
		-not ($pkgsToIgnore | Where-Object { $line -like "*$_*" })
	}
	if ($list.Count -eq 0) {
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUmWLQUZ0FzYfz+4OfG7MCBRgY
# UvigggPIMIIDxDCCAqygAwIBAgIQRqaG/Zc3Po5BF31FOLqbBTANBgkqhkiG9w0B
...
# bxW2q4wvro+wHlC8ye9rn5vGCjANBgkqhkiG9w0BAQEFAASCAQAYwrhitlb50DSf
# Cl4Xv93HnnWWmdgVJAtJXnrvP7YW1SANF/ugcSqIr54UlYqa9cwknxcvkSvWLYLE
# +vVqVinLvr2VfhuEIldQhhvvzBmjW6BbkpFV1Ew7WHqP0QTIZa18hlnKVDPrwMId
# s0AemyISX2Ww+4CYP7u+oJk98eXPFcxEXQVb+yiQKbURePQ9uGRhjLlU0zQF46pr
# 9SF9C962kWvE8Ju604L9Cp17gWubJsQkBav7Ch7tUamu90NUBLL0v9KrYgVK9hs5
# e0MKlIEt5PHsIShfrzMqpeK0u52m/58wIIi9eI0xDp9rR26sA2hPb+ltLOOdoCty
# 36EOkGc8
